package com.redhat.fis.sandbox.ws;
...
//        URLConnection connection = new URL("http://localhost:9000/ws/subscriber").openConnection();
        URLConnection connection = new URL("http://fis-sanbox-ws-fis-sandbox.rhel-cdk.10.1.2.4.xip.io/cxf/subscriber").openConnection();
